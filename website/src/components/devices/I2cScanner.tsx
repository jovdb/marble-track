...
export default function I2cScanner(props: I2cScannerProps) {
  return (
    ...
    >
      ...
      >
        <For
          each={props.foundAddresses}
          fallback={
            <span style={{ opacity: 0.5, "font-size": "0.8rem" }}>None found. Click Scan.</span>
          }
        >
          {(addr) => (
            <span
              onClick={() => props.onSelectAddress?.(addr)}
              style={{
                ...
                "font-size": "0.8rem",
                cursor: props.onSelectAddress ? "pointer" : "default",
              }}
            >

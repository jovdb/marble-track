    ...
    <div class={styles["collapsible-section"]}>
      ...
      >
        <div class={styles["collapsible-section__title"]}>
          {props.icon && (
            <span class={styles["collapsible-section__icon"]}>
              {props.icon}
            </span>
          )}
        ...
        <div class={styles["collapsible-section__header-actions"]}>
          {props.headerAction && !isCollapsed() && (
            <span class={styles["collapsible-section__action"]} onClick={(e) => e.stopPropagation()}>
              {props.headerAction}
            </span>
          )}
          <div class={`${styles["collapsible-section__chevron"]} ${
      ...
      <div class={`${styles["collapsible-section__content"]} ${
        isCollapsed() ? styles["collapsible-section__content--collapsed"] : ""
      }`}>
        <div class={styles["collapsible-section__inner"]}>
          {props.children}
        </div>
      </div>
    </div>
